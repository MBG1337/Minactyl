...
console.log(chalk.yellow("[Minactyl] Loading files..."));

console.log(chalk.cyan("[Minactyl] Files loaded!"));

// Load settings.

const settings = require("./settings.json");
console.log(chalk.yellow("[Minactyl] Loading settings..."));
...
console.log(chalk.cyan("[Minactyl] Settings loaded!"));
...
console.log(chalk.yellow("[Minactyl] Loading database..."))

module.exports.db = db;

console.log(chalk.cyan("[Minactyl] Database loaded!"))

// Load websites.

const express = require("express");
console.log(chalk.yellow("[Minactyl] Loading api's..."))
const app = express();
console.log(chalk.cyan("[Minactyl] Api's loaded!"))

// Load express addons.

const expressWs = require('express-ws')(app);
console.log(chalk.yellow("[Minactyl] Loading express addons..."))
const ejs = require("ejs");
const session = require("express-session");
const indexjs = require("./index.js");
console.log(chalk.cyan("[Minactyl] Express addons loaded!"))


// Sets up saving session data.

const sqlite = require("better-sqlite3");
console.log(chalk.yellow("[Minactyl] Loading session data..."))
const SqliteStore = require("better-sqlite3-session-store")(session);
const session_db = new sqlite("sessions.db");
console.log(chalk.cyan("[Minactyl] Season data loaded!"))

// Load the website.

module.exports.app = app;
console.log(chalk.yellow("[Minactyl] Starting up Minactyl..."))
app.use(session({
...
console.log(chalk.magenta("[Minactyl Client] ©️ Links: [Github] https://github.com/MBG-Codes-You/Minactyl"));
console.log(chalk.blue("=================================================="))
console.log(chalk.magenta("[Contributors] | MBG#1337"));
console.log(chalk.blue("=================================================="))
const listener = app.listen(settings.website.port, function() {
  console.log(chalk.cyan("[Minactyl] Minactyl started on port " + listener.address().port +" "));
});
...
app.all("*", async (req, res) => {
  ...
  function (err, str) {
    ...
    delete req.session.password;
    if (err) {
      console.log(chalk.red(`[Minactyl] An error has occured on path ${req._parsedUrl.pathname}:`));
      console.log(err);
      return res.send("An error has occured while attempting to load this page. Please contact an administrator to fix this.");
    };
    res.status(404);
